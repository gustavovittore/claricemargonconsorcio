...
const columns = [
  ...
  },
  {
    title: (
      <>
        <span className="block sm:inline">Por que investir</span>{" "}
        <span className="block sm:inline">no <span className="text-[#E19D35]">Brasil</span>?</span>
      </>
    ),
        ...
        <div className="px-6 py-12 sm:px-10 sm:py-14 lg:px-24 lg:py-24">
          <div className="grid gap-10 divide-y divide-[#E19D35]/38 lg:grid-cols-2 lg:gap-0 lg:divide-x lg:divide-y-0">
            {columns.map((column) => (
              ...
              >
                <h2 className="max-w-[16ch] font-serif text-[2.1rem] font-medium leading-[1.08] text-[#1F1F1F] sm:max-w-[13ch] sm:text-[3.25rem] lg:text-[3.45rem]">
                  {column.title}
                </h2>
